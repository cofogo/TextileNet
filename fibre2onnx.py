...
model = vit_test(num_classes=33)

# Load the checkpoint
checkpoint_path = 'baselines/TextileNet-fibre/vits_ckpt.pth'
...
onnx_path = 'onnxmodels/fibre.onnx'
torch.onnx.export(
    model,
    input_tensor,
    onnx_path,
    ...
    input_names=['input'],
    output_names=['fibre'],
    dynamic_axes={'input': {0: 'batch_size'}, 'fibre': {0: 'batch_size'}}
)